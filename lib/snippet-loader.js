...
// TODO: swap out for config file in snippets directory
	...
	return {
		load: function( config ) {
			...
			model.snippets = _.map( snippetFiles, function( snippetPath, idx ) {
				...
				snippetData.__abbreviation = userSettings.snippetPrefix + path.basename( snippetPath, '.snippet' ) + userSettings.snippetPostfix;
